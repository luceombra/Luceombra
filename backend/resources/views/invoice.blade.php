...
<body>
    <div class="row">
        ...
        <br/>
        <h4><span>Conferma d’ordine nr. {{ $invoiceNo }} del {{ $date }}</span></h4>
    ...
    <div class="container">
        ...
        <div style="margin-top: 70px;">
            <div style="width: 240px;">
                <p class="signature">Timbro e firma per accettazione</p>
                <div class="border-bottom pd-t-25"></div>
            </div>
        </div>
        <div class="page-break"></div>
        <div>{!! $shop->confirmation_order_note !!}</div>
    </div>
</div>
